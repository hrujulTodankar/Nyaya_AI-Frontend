...
async function handleRequest(request, requestId, handlers, options, emitter, handleRequestOptions) {
  var _a6, _b3, _c3, _d2, _e2, _f;
  emitter.emit("request:start", { request, requestId });
  if ((_a6 = request.headers.get("accept")) == null ? void 0 : _a6.includes("msw/passthrough")) {
...
var WebSocketOverride = class extends EventTarget {
  ...
  send(data) {
    ...
    queueMicrotask(() => {
      var _a6;
      this.bufferedAmount = 0;
      (_a6 = this[kOnSend]) == null ? void 0 : _a6.call(this, data);
    });
  }
...
invariant2.as = (ErrorConstructor, predicate, message2, ...positionals) => {
  if (!predicate) {
    const formatMessage = positionals.length === 0 ? message2 : format(message2, ...positionals);
    let error2;
    try {
...
var DeferredPromise2 = (_a2 = class extends Promise {
...
function enableMocking(context, options) {
  ...
  context.workerChannel.once("MOCKING_ENABLED", async (event) => {
    ...
    printStartMessage({
      quiet: options.quiet,
      workerScope: (_a6 = context.registration) == null ? void 0 : _a6.scope,
...
function getVariable(variableName) {
  ...
  return (_a6 = globalThis[variableName]) == null ? void 0 : _a6.toString();
}
...
var Interceptor2 = class {
  ...
  getInstance() {
    ...
    this.logger.info("retrieved global instance:", (_a6 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a6.name);
    return instance;
  }
  setInstance() {
...
var _FetchResponse = class extends Response {
  ...
  constructor(body, init = {}) {
    var _a6;
    const status = (_a6 = init.status) != null ? _a6 : 200;
...
function createResponseListener(context) {
  return (event) => {
    ...
    if ((_a6 = responseMessage.response.type) == null ? void 0 : _a6.includes("opaque")) {
      return;
    }
...
var _a3, _b2, _c2, _d, _returnType, _e;
var TypedEvent = (_e = class extends (_d = MessageEvent, _c2 = kDefaultPrevented2, _b2 = kPropagationStopped, _a3 = kImmediatePropagationStopped, _d) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
var _listeners, _Emitter2_instances, addListener_fn, proxyEvent_fn, callListener_fn, _a4;
var Emitter22 = (_a4 = class {
  constructor() {
  ...
  *emitAsGenerator(event) {
  ...
  var _a6;
  (_a6 = __privateGet(this, _listeners))[type] ?? (_a6[type] = []);
  ...
  if ((_a6 = listener[kListenerOptions]) == null ? void 0 : _a6.once) {
    this.removeListener(event.type, listener);
  }
  return returnValue;
}, _a4);
var SUPPORTS_SERVICE_WORKER = supportsServiceWorker();
var _workerEvent, _a5;
var WorkerEvent = (_a5 = class extends TypedEvent {
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a6;
              const onceRequestSettled = ((_a6 = this.onRequest) == null ? void 0 : _a6.call(this, {
                request: fetchRequest,
                requestId: this.requestId
              })) || Promise.resolve();
...
var SetupWorkerApi = class extends SetupApi {
  ...
  stop() {
    ...
    window.postMessage({ type: "msw/worker:stop" });
    printStopMessage({
      quiet: (_a6 = this.context.startOptions) == null ? void 0 : _a6.quiet
    });
  }
};
...
//# sourceMappingURL=browser-PFWKYFBJ.js.map
